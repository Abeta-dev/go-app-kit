...
### Changed
- ci: Bumped GitHub Actions dependencies across all workflows (`actions/checkout` v7.0.1, `dorny/paths-filter` v4.0.3, `actions/setup-go` v7.0.0, `actions/upload-artifact` v7.0.1, `actions/configure-pages` v6, `actions/upload-pages-artifact` v5, `actions/deploy-pages` v5, `actions/download-artifact` v8.0.1).
- docs: Updated interactive documentation portal and release references to `v0.4.1`.
