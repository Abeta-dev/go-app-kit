...
> Current main-line published release: `v0.3.1`. The lightweight `v0.3.0` tag points to an earlier commit and remains an immutable, separate artifact. See [Release Baseline](docs/RELEASE_BASELINE.md) before selecting a release or publishing a reconciliation.
...
```bash
go get github.com/umesh0492/go-app-kit@v0.3.1
```
